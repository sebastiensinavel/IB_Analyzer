...
Si une table sectorielle réelle est disponible dans `private/` (`ls` d'abord) :
Run: `node .claude/skills/run-frontend/driver.mjs /accounts/beta/sectors --seed --sectors=private/company.csv`
